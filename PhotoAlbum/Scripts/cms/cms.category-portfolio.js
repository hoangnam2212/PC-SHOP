...
function addCate() {
	if ($('#cateName').val().trim() == "") {
		...
		$.ajax({
			type: "POST",
            url: location.protocol + '//' + location.host + "/CMS_Portfolio/AddCategory",
			...
			success: function (content) {
				...
				$.ajax({
					type: "POST",
                    url: location.protocol + '//' + location.host + "/CMS_Portfolio/GetParentCategory",
					dataType: "html",
					success: function (content) {
...
function saveEdit() {
	...
	$.ajax({
		type: "POST",
        url: location.protocol + '//' + location.host + "/CMS_Portfolio/EditCateById",
...
function deleteCate(id) {
	...
	if (r == true) {
		$.ajax({
			type: "POST",
            url: location.protocol + '//' + location.host + "/CMS_Portfolio/DeleteCategory",
			data: { cateId: id },
			success: function (content) {
				$('#div-content').html(content);
				$.ajax({
